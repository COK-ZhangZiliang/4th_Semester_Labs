...
void Gaming::on_confirm_pushButton_clicked()
{
    ...
    if (input_word == ui->show_word_label->text())
    {
        ...
        {
            // 增加闯关者经验值
            int add_exp = this->current_level + round_time[this->current_level] * total_rounds[this->current_level] - this->cost_time;
            ...
            // 更新闯关者数据
            emit this->passed(current_level - 1, add_exp);
